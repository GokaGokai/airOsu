...
print("------------------")
print("")
print("Press z or c to start")
print("")
print("Once started, resize the window to make it smaller until you can only see the BPM line.")
print("It can be used without focusing on this window, it recycles/resets the BPM every 10 seconds")
print("For now, it's made to be used with 2 AutoHotkey scripts or similar, (If you want to multitask)\nbut it can be used without.")
print("")
print("Keys:")
print("-z")
print("-c")
...
print("")
print("Scripts: (Optional)")
print("-an Always-On-Top script")
print("-a togglabe script that disables the z and x keys\n(I made one for myself, contact me if you want it or want to know how)")
print("")
