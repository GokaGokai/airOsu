...
# from pynput import keyboard
def play_sound():
    audio_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'normal-hitnormal.wav')
    winsound.PlaySound(audio_path[0:-4], winsound.SND_ALIAS|winsound.SND_ASYNC)
